class ASCII3DShape:
    ...
    def get_user_input(self):
        """Отримання типу фігури та параметрів від користувача."""
    ...
    def generate_3d_shape(self):
        """Створення 3D-представлення фігури."""
    ...
    def _generate_cube(self):
        """Створення ASCII-представлення куба."""
        cube = []
        size = self.size
        for i in range(size):
    ...
    def _generate_sphere(self):
        """Створення ASCII-представлення сфери."""
        sphere = []
        radius = self.size // 2
    ...
    def display_ascii_art(self):
        """Відображення згенерованої ASCII-фігури."""
